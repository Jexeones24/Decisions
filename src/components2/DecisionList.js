...
export default class DecisionList extends Component {
  ...
  handleDelete = (e) => {
    let decision = this.state.content
    console.log(this.state.content)
    this.props.deleteDecision(decision)
    this.setState({
      content: "",
      disabled: !this.state.disabled,
      editable: !this.state.editable
  ...
  handleEdit = () => {
    ...
    this.props.editDecision(this.state.content)
  }
  ...
  deleteOpinion = (opinionContent) => {
    console.log("delete opinion", opinionContent)
        ...
        <Form>
          <Form.Field>
            ...
            <div className="decision-bar">
              ...
              <Button icon='delete' disabled={!this.state.content} onClick={this.handleDelete.bind(this)}/>
              <Button disabled={!this.state.content} icon='edit' onClick={this.handleEdit.bind(this)}/>
          ...
          {this.state.formVisible ? <div className="outcome-form"><OutcomeForm createOutcome={this.props.createOutcome} createOpinion={this.props.createOpinion}
